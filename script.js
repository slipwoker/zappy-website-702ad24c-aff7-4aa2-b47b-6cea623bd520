document.addEventListener('DOMContentLoaded', function() {
  ...
  const animateElements = document.querySelectorAll('.fade-in, [data-animate="fade-in"], .animate-on-scroll');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '702ad24c-aff7-4aa2-b47b-6cea623bd520',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '702ad24c-aff7-4aa2-b47b-6cea623bd520';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '702ad24c-aff7-4aa2-b47b-6cea623bd520';
